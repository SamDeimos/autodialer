		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="settings.php" class="btn btn-success" title="Configuración"><i
								class="material-icons">&#xE8B8;</i> <span>Configuración</span></a>
						<a href="#addCampModal" class="btn btn-success" data-toggle="modal"><i
								class="material-icons">&#xE147;</i> <span>Agregar nueva campaña</span></a>
					</div>
				</div>
			</div>
