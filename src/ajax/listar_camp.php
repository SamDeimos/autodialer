			...
			<table class="table table-striped table-hover">
				...
				<tbody>	
						...
						<tr>
							...
							<td width="150">
								<a href="#" data-target="<?php echo $status=='terminada' ? '' : '#startCampModal'?>" class="start_camp <?php echo $status=='terminada' ? 'end_camp' : ''?>  <?php echo $status=='activa' ? 'd-none' : ''?> " data-toggle="modal" data-id="<?php echo $camp_id?>"><i class="material-icons disabled" data-toggle="tooltip" title="Iniciar llamadas">&#xE0B0;</i></a>
