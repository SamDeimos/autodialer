...
$query = mysqli_query($conAstetisk, "SELECT * FROM trunks");
$c = 0;
						...
						<div class="form-group col-6">
							...
							<div class="input-group input-group-sm mb-3">
								...
								<select class="form-control form-control-sm" id="trunk" name="trunk">
									...
									<option
										value="<?php echo strtoupper($fila['tech']).'/'.$fila['channelid']; ?>">
										<?php echo $fila['name']; ?>
									</option>
									<?php
									}
?>
						...
						<div class="form-group col-6">
							...
							<div class="container">
								<div class="row">
									<input class="form-control form-control-sm col" id="camp_h_ini" name="camp_h_ini"
										type="time" value="00:00">
									<p class="col-3 text-center">Hasta</p>
									<input class="form-control form-control-sm col" id="camp_h_fin" name="camp_h_fin"
					...
					<div class="row">
						<div class="form-group col-6">
							...
							<input type="text" name="maxcall" id="maxcall" class="form-control form-control-sm"
								value="1" required>
						</div>
						<div class="form-group col-6">
							<label>Grabar llamadas</label><br>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" value="1" name="grabar" id="grabar1">
								<label class="form-check-label" for="grabar1">
									Habilitar
								</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" value="0" name="grabar" id="grabar0"
									checked>
								<label class="form-check-label" for="grabar0">
									Deshabilitar
								</label>
							</div>
						</div>
					...
					<div class="row">
						<div class="form-group col-12">
							...
							<div class="custom-file">
								<input type="file" name="csvcustomFile" id="csvcustomFile" class="custom-file-input"
									required>
								<label class="custom-file-label" for="csvcustomFile"
									data-browse="Buscar archivo">Seleccionar Archivo</label>
							</div>
						</div>
					</div>
				</div>
